...
Version  : 9.14.9
Release  : 68
URL      : https://downloads.isc.org/isc/bind9/9.14.9/bind-9.14.9.tar.gz
Source0  : https://downloads.isc.org/isc/bind9/9.14.9/bind-9.14.9.tar.gz
Source1  : https://downloads.isc.org/isc/bind9/9.14.9/bind-9.14.9.tar.gz.asc
...
%prep
%setup -q -n bind-9.14.9
cd %{_builddir}/bind-9.14.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576812544
...
cp %{_builddir}/bind-9.14.9/COPYRIGHT %{buildroot}/usr/share/package-licenses/bind-utils/fd0b1224c11e9cb6c0a3c03e5314c51aefb94a96
cp %{_builddir}/bind-9.14.9/LICENSE %{buildroot}/usr/share/package-licenses/bind-utils/ece3df1263c100f93c427face535a292723d38e7
cp %{_builddir}/bind-9.14.9/bin/tests/system/dyndb/driver/COPYING %{buildroot}/usr/share/package-licenses/bind-utils/39f18898eca8d182f9386279eae016ca016a8c84
cp %{_builddir}/bind-9.14.9/doc/arm/notes-license.xml %{buildroot}/usr/share/package-licenses/bind-utils/885e67b30439d3ff1c3cec2f0277b7779775b90f
%make_install
