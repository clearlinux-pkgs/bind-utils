...
Source0  : https://downloads.isc.org/isc/bind9/9.16.8/bind-9.16.8.tar.xz
Source1  : https://downloads.isc.org/isc/bind9/9.16.8/bind-9.16.8.tar.xz.asc
...
%prep
%setup -q -n bind-9.16.8
cd %{_builddir}/bind-9.16.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603334044
...
cp %{_builddir}/bind-9.16.8/LICENSE %{buildroot}/usr/share/package-licenses/bind-utils/ece3df1263c100f93c427face535a292723d38e7
cp %{_builddir}/bind-9.16.8/bin/tests/system/dyndb/driver/COPYING %{buildroot}/usr/share/package-licenses/bind-utils/39f18898eca8d182f9386279eae016ca016a8c84
%make_install
