...
Source0  : https://downloads.isc.org/isc/bind9/9.16.11/bind-9.16.11.tar.xz
...
%prep
%setup -q -n bind-9.16.11
cd %{_builddir}/bind-9.16.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611432142
...
cp %{_builddir}/bind-9.16.11/COPYRIGHT %{buildroot}/usr/share/package-licenses/bind-utils/9f45eef88030996c88e6adfbc2b58dacd8ec8f23
cp %{_builddir}/bind-9.16.11/LICENSE %{buildroot}/usr/share/package-licenses/bind-utils/ece3df1263c100f93c427face535a292723d38e7
cp %{_builddir}/bind-9.16.11/bin/tests/system/dyndb/driver/COPYING %{buildroot}/usr/share/package-licenses/bind-utils/39f18898eca8d182f9386279eae016ca016a8c84
%make_install
...
/usr/lib64/libbind9.so.1600.0.7
/usr/lib64/libdns.so.1611
/usr/lib64/libdns.so.1611.0.0
/usr/lib64/libirs.so.1601
/usr/lib64/libirs.so.1601.0.0
/usr/lib64/libisc.so.1609
/usr/lib64/libisc.so.1609.0.0
/usr/lib64/libisccc.so.1600
/usr/lib64/libisccc.so.1600.0.2
/usr/lib64/libisccfg.so.1603
/usr/lib64/libisccfg.so.1603.0.0
/usr/lib64/libns.so.1607
/usr/lib64/libns.so.1607.0.0
