...
Source0  : https://downloads.isc.org/isc/bind9/9.18.9/bind-9.18.9.tar.xz
Source1  : https://downloads.isc.org/isc/bind9/9.18.9/bind-9.18.9.tar.xz.asc
...
%prep
%setup -q -n bind-9.18.9
cd %{_builddir}/bind-9.18.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668640772
...
/usr/lib64/libbind9-9.18.9.so
/usr/lib64/libbind9.so
/usr/lib64/libdns-9.18.9.so
/usr/lib64/libdns.so
/usr/lib64/libirs-9.18.9.so
/usr/lib64/libirs.so
/usr/lib64/libisc-9.18.9.so
/usr/lib64/libisc.so
/usr/lib64/libisccc-9.18.9.so
/usr/lib64/libisccc.so
/usr/lib64/libisccfg-9.18.9.so
/usr/lib64/libisccfg.so
/usr/lib64/libns-9.18.9.so
/usr/lib64/libns.so
