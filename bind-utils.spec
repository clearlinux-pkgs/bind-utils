...
#
# Source0 file verified with key 0x510A642A06C52CEC (michal@isc.org)
#
%define keepstatic 1
Name     : bind-utils
Version  : 9.18.27
...
Source0  : https://downloads.isc.org/isc/bind9/9.18.27/bind-9.18.27.tar.xz
Source1  : https://downloads.isc.org/isc/bind9/9.18.27/bind-9.18.27.tar.xz.asc
Source2  : 510A642A06C52CEC.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 510A642A06C52CEC' gpg.status
%setup -q -n bind-9.18.27
cd %{_builddir}/bind-9.18.27
pushd ..
cp -a bind-9.18.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715873620
...
/V3/usr/lib64/libbind9-9.18.27.so
/V3/usr/lib64/libdns-9.18.27.so
/V3/usr/lib64/libirs-9.18.27.so
/V3/usr/lib64/libisc-9.18.27.so
/V3/usr/lib64/libisccc-9.18.27.so
/V3/usr/lib64/libisccfg-9.18.27.so
/V3/usr/lib64/libns-9.18.27.so
/usr/lib64/bind/filter-a.so
/usr/lib64/bind/filter-aaaa.so
/usr/lib64/libbind9-9.18.27.so
/usr/lib64/libbind9.so
/usr/lib64/libdns-9.18.27.so
/usr/lib64/libdns.so
/usr/lib64/libirs-9.18.27.so
/usr/lib64/libirs.so
/usr/lib64/libisc-9.18.27.so
/usr/lib64/libisc.so
/usr/lib64/libisccc-9.18.27.so
/usr/lib64/libisccc.so
/usr/lib64/libisccfg-9.18.27.so
/usr/lib64/libisccfg.so
/usr/lib64/libns-9.18.27.so
/usr/lib64/libns.so
