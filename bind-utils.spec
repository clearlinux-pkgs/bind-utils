...
Source0  : https://downloads.isc.org/isc/bind9/9.20.5/bind-9.20.5.tar.xz
Source1  : https://downloads.isc.org/isc/bind9/9.20.5/bind-9.20.5.tar.xz.asc
...
%setup -q -n bind-9.20.5
cd %{_builddir}/bind-9.20.5
pushd ..
cp -a bind-9.20.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738179855
...
/V3/usr/lib64/libdns-9.20.5.so
/V3/usr/lib64/libisc-9.20.5.so
/V3/usr/lib64/libisccc-9.20.5.so
/V3/usr/lib64/libisccfg-9.20.5.so
/V3/usr/lib64/libns-9.20.5.so
/usr/lib64/bind/filter-a.so
/usr/lib64/bind/filter-aaaa.so
/usr/lib64/libdns-9.20.5.so
/usr/lib64/libdns.so
/usr/lib64/libisc-9.20.5.so
/usr/lib64/libisc.so
/usr/lib64/libisccc-9.20.5.so
/usr/lib64/libisccc.so
/usr/lib64/libisccfg-9.20.5.so
/usr/lib64/libisccfg.so
/usr/lib64/libns-9.20.5.so
/usr/lib64/libns.so
