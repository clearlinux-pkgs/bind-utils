...
Source0  : https://downloads.isc.org/isc/bind9/9.16.19/bind-9.16.19.tar.xz
Source1  : https://downloads.isc.org/isc/bind9/9.16.19/bind-9.16.19.tar.xz.asc
...
%prep
%setup -q -n bind-9.16.19
cd %{_builddir}/bind-9.16.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626976480
...
cp %{_builddir}/bind-9.16.19/LICENSE %{buildroot}/usr/share/package-licenses/bind-utils/ece3df1263c100f93c427face535a292723d38e7
cp %{_builddir}/bind-9.16.19/bin/tests/system/dyndb/driver/COPYING %{buildroot}/usr/share/package-licenses/bind-utils/39f18898eca8d182f9386279eae016ca016a8c84
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libbind9-9.16.19.so
/usr/lib64/libbind9.so
/usr/lib64/libdns-9.16.19.so
/usr/lib64/libdns.so
/usr/lib64/libirs-9.16.19.so
/usr/lib64/libirs.so
/usr/lib64/libisc-9.16.19.so
/usr/lib64/libisc.so
/usr/lib64/libisccc-9.16.19.so
/usr/lib64/libisccc.so
/usr/lib64/libisccfg-9.16.19.so
/usr/lib64/libisccfg.so
/usr/lib64/libns-9.16.19.so
/usr/lib64/libns.so
